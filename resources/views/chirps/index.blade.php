<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {{-- Actualizando la página index para que muestre el tweet --}}
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                {{-- Mostraremos una indicación si un Chirp ha sido editado comparando la fecha de creación del 
                                    Chirp con su fecha de actualización(update). --}}
